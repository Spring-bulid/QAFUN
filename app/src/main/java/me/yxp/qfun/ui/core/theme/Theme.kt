...
private val LightColorScheme = lightColorScheme(
    primary = AccentPurple, onPrimary = Color.White,
    secondary = AccentCyan, onSecondary = Color.Black,
...
private val DarkColorScheme = darkColorScheme(
    primary = AccentPurpleDark, onPrimary = Color.White,
    secondary = AccentCyanDark, onSecondary = Color.Black,
...
fun QFunTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
    ...
    val qfunColors = QFunColors(
        ...
        accentBlue = if (darkTheme) AccentPurpleDark else AccentPurple,
        accentRed = AccentRed,
        accentPurple = if (darkTheme) AccentPurpleDark else AccentPurple,
        accentCyan = if (darkTheme) AccentCyanDark else AccentCyan,
